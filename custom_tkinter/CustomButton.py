...
class CustomButton(Button):
    ...
    def __init__(self, location, text, funcs):
        super().__init__(location, text=text, font=self.FONT, bg="black", activebackground="white", fg="white",
                         activeforeground="black", borderwidth=0, cursor="hand2", command=combine_funcs(funcs))
